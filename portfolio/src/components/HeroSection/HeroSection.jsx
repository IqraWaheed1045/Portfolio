...
const HeroSection = () => {
    return (
        <div className='w-full h-screen p-1 flex items-center flex-col bg-gray-500 font-Ubuntu hero'>
            <h2 className='font-Ubuntu md:text-[50px] text-[80px] text-bold my-14 text-yellow-400'>Portfolio</h2>
            {/*Left Part */}
            <div className='flex-1  pl-[70px] text-yellow-400 flex flex-col justify-center  '>
                <h4 className='md:text-[13px] text-[30px] tracking-wider lg:leading-4 leading-7 uppercase'>Combination of Technology and Creativity.</h4>
                <h2 className='text-[40px] font-bold leading-11 mr-[20px] '>Code that speaks, designs that captivate, and experiences that last</h2>
                <p className='md:text-[15px] text-[20px]'>I Iqra Waheed a passionate Frontend Developer having strong <span>Knowledge</span> about HTML,CSS (Tailwindcss(Material UI,Desi UI),Bootsrap) ,JavaScript,React Js.</p>
                <div className='my-4'>
